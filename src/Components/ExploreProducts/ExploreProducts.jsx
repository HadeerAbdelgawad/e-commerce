...
function ExploreProducts({item}) {
  ...
  return <>
    ...
    <div className='product_container col-md-3 d-flex justify-content-center align-items-center'>
        <div className="product position-relative">
          ...
          <div className="rating">
            ...
            {/* <div className='overlay'>
              <button className='btn btn-dark btn-sm w-100 h-15 bottom-0 position-absolute' style={{color:'white'}}>Add To Cart</button>
            </div> */}
